...
export const metadata: Metadata = {
  title: 'How It Works — 4-Step White-Label Development Process | Fuserr Solutions',
  description:
    'Our simple 4-step white-label process: Kickoff & NDA, Plan & Estimate, Build & Test, Launch & Handoff. Transparent, agency-friendly, invisible to your clients.',
};
