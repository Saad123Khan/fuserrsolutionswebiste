      ...
      <div className="relative w-full pb-[56.25%] bg-slate-50 dark:bg-navy-700">
        ...
        <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between z-10">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center text-white font-bold text-base shadow-sm" style={{ background: color }}>
              {title[0]}
            </div>
            <div>
              <div className="text-sm font-semibold text-white leading-tight">{title}</div>
              <div className="text-xs font-mono text-white/80" style={{ color }}>{industry}</div>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div style={{ ['--accent' as any]: project.color }} className="h-full rounded-3xl overflow-hidden border border-slate-100 dark:border-navy-700 bg-white/60 dark:bg-navy-800/40 backdrop-blur-sm shadow-lg hover:shadow-2xl transform-gpu hover:-translate-y-1 transition-all duration-300 flex flex-col">
                    ...
                    <div className="p-4 flex items-center justify-between gap-4">
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-slate-400 dark:text-[#64748B] mt-1">{project.year}</div>
                      </div>
