        ...
        <AnimatedSection className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight mb-6">
              <span className="text-slate-900">We&apos;re your invisible</span>
              <br />
          ...
          <div className="relative">
            <div className="glass rounded-2xl border border-slate-200 p-8">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={l} className="bg-slate-100 rounded-xl p-5">
          ...
          {pillars.map((p, i) => {
            ...
            return (
              <AnimatedSection key={p.title} delay={i * 0.1}>
                <div className="glass rounded-2xl border border-slate-200 p-6 h-full hover:border-blue-600/30 transition-colors duration-300">
                  <div className="w-10 h-10 rounded-xl bg-blue-600/10 border border-blue-600/20 flex items-center justify-center mb-5">
                    <Icon size={18} className="text-blue-400" />
                  </div>
                  <h3 className="text-slate-900 font-semibold mb-3">{p.title}</h3>
