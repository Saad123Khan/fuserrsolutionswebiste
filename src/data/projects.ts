...
export const projects: Project[] = [
  ...
  },
  {
    ...
    cover: '/image5.png',
    color: '#7C3AED',
    overview: 'A visual redesign and frontend overhaul to improve conversions and brand perception.',
    challenge: 'Low visual consistency and poor mobile conversions.',
    solution: 'Redesigned product pages with optimized imagery and interactive previews.',
    results: [
  ...
  },
  {
    ...
    cover: '/image6.png',
    color: '#F97316',
    overview: 'A focused visual refresh to showcase product imagery and micro-interactions.',
    challenge: 'Inconsistent imagery and weak visual hierarchy across product pages.',
    solution: 'Introduced a cohesive visual system, improved image performance, and interactive previews.',
    results: [
      { metric: '28%', label: 'Engagement increase' },
      { metric: '1.6×', label: 'Time on page' },
    ],
    tech: ['Next.js', 'Tailwind', 'Sketch'],
  },
];
